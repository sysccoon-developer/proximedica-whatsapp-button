window.addEventListener('load', () => {
    ...
    (() => {
        const whats = {
            leon: {
                soporte: document.getElementById('whatsLeon'),
                ventas: document.getElementById('whatsVLeon'),
            },
            mty: {
                soporte: document.getElementById('whatsMty'),
                ventas: null,
            },
            salt: {
                soporte: document.getElementById('whatsSaltillo'),
                ventas: null,
            },
            cdmx: {
                soporte: document.getElementById('whatsCdmx'),
                ventas: null,
            },
            cancun: {
                soporte: document.getElementById('whatsCancun'),
                ventas: null,
            }
        }
        let isMobile = false;
        ...
        for (city of Object.keys(whats)) {
            const soporte = whats[city].soporte;
            const ventas = whats[city].ventas;
            soporte && (soporte.href = getHref(
                isMobile,
                soporte.getAttribute('whats'),
                soporte.getAttribute('whatstype'),
                soporte.getAttribute('whatscity')
            ));
            ventas && (ventas.href = getHref(
                isMobile,
                ventas.getAttribute('whats'),
                ventas.getAttribute('whatstype'),
                ventas.getAttribute('whatscity')
            ));
        }
    })();
});